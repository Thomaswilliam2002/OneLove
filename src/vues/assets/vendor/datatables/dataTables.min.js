...
b[2].toLowerCase()),d[c]=e,"o"===b[1]&&E(a[e]))});a._hungarianMap=d}function P(a,b,c){a._hungarianMap||E(a);var d;l.each(b,function(e,h){d=a._hungarianMap[e];d===q||!c&&b[d]!==q||("o"===d.charAt(0)?(b[d]||(b[d]={}),l.extend(!0,b[d],b[e]),P(a[d],b[d],c)):b[d]=b[e])})}function ma(a){var b=u.defaults.oLanguage,c=b.sDecimal;c&&Wa(c);if(a){var d=a.sZeroRecords;!a.sEmptyTable&&d&&"Aucun résultat a affiché"===b.sEmptyTable&&X(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&d&&"Loading..."===b.sLoadingRecords&&
...
sNext:"Suivant",sPrevious:"précédent"},sEmptyTable:"Aucun résultat a affiché",sInfo:"Affichage de _START_ a _END_ sur _TOTAL_ entrées",sInfoEmpty:"Affichage de 0 a 0 sur 0 entrées",sInfoFiltered:"(filtré a partir de _MAX_ entrées au total)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Rechercher:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun resultat trouver"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
